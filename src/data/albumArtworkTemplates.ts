// 10 Official Artist Photos for Waranrat K. — "ถ้าเธอยังไม่ลืม" Official Debut Album
...
export const DEFAULT_SLIDES_PRESETS: PresetSlide[] = [
  {
    ...
    description: 'เพลงไตเติลหลักเดบิวต์อัลบั้ม Waranrat K. รอยยิ้มอบอุ่นน่ารัก สดใสเป็นธรรมชาติ',
